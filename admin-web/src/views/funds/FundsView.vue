  ...
  <div class="page-stack funds-page">
      ...
      <article class="panel-card funds-detail-card">
        ...
        <template v-else>
          ...
          <div class="funds-action-row">
            <ElButton type="warning" @click="openSupplementDialog">手工补录{{ currentDocTypeLabel }}</ElButton>
            <ElButton type="success" :disabled="!isConfirmable" @click="openConfirmDialog">确认当前单据</ElButton>
          </div>
    ...
    <ElDialog v-model="supplementDialog.visible" width="560" :title="`手工补录${currentDocTypeLabel}`">
      ...
      <template #footer>
        ...
        <ElButton type="primary" :loading="supplementDialog.submitting" @click="submitSupplement">确认补录</ElButton>
      </template>
    </ElDialog>
    ...
    <ElDialog v-model="confirmDialog.visible" width="600" title="确认资金单据">
      ...
      <template #footer>
        ...
        <ElButton type="primary" :loading="confirmDialog.submitting" @click="submitConfirm">确认提交</ElButton>
      </template>
    </ElDialog>
  </div>
</template>
