...
import { parseFundsReconcileRouteQuery } from '@/utils/report-drill'
...
const drillEntryText = computed(() => {
  const drillQuery = parseFundsReconcileRouteQuery(route.query)
  ...
  const groupLabel = drillGroup === 'refund_status' ? '退款状态' : '维度'
