...
class OutboundDoc(Base):
    ...
    source_ticket_no: Mapped[str | None] = mapped_column(String(64), nullable=True, index=True)
    manual_ref_no: Mapped[str | None] = mapped_column(String(64), nullable=True, index=True)
    ...
    contract: Mapped["Contract"] = relationship(back_populates="outbound_docs")
    sales_order: Mapped["SalesOrder"] = relationship(back_populates="outbound_docs")
