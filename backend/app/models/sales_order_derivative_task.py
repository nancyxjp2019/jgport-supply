...
class SalesOrderDerivativeTask(Base):
    __tablename__ = "sales_order_derivative_tasks"
    ...
    sales_order: Mapped["SalesOrder"] = relationship(back_populates="derivative_tasks")
